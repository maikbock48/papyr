        ...
        <div className="relative z-10 w-full h-full flex flex-col">
          ...
          <div className="relative hidden lg:block" style={{ zIndex: 20 }}>
            <div className="text-center">
              <div className="absolute bg-white rounded-xl shadow-lg dashboard-onboarding-card" style={{ right: '40px', marginTop: '260px', border: '0.5px solid black', padding: '12px', zIndex: 20 }}>
              ...
              {/* Spielregeln Link */}
              <div className="absolute bg-white rounded-xl shadow-lg dashboard-onboarding-card" style={{ right: '40px', marginTop: '400px', border: '0.5px solid black', padding: '12px', zIndex: 20 }}>
                <h3 className="text-lg font-bold mb-0.5" style={{ color: '#2d2e2e' }}>
                  Spielregeln
                </h3>
                <p className="text-sm mb-1.5" style={{ color: '#666', lineHeight: '1.3' }}>
          ...
          <div className="relative hidden lg:block" style={{ zIndex: 15 }}>
            <div className="text-center">
              <div className="absolute transform rotate-[3deg]" style={{ right: '40px', marginTop: '20px', zIndex: 15, transform: 'rotate(3deg) scale(1)' }}>
                  <div className="bg-white shadow-lg rounded-xl p-4 dashboard-calendar" style={{ border: '0.5px solid black' }}>
                    {/* Calendar Header */}
          ...
          {/* Center content area */}
          <div className="flex-1 flex flex-col items-center pt-40 px-4 relative">
          ...
          <div className="absolute bottom-20 right-32 flex flex-col items-center gap-2 animate-bounce">
